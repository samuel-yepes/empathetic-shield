...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-midnight">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-24 pb-16">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-card mb-8 text-sm text-mutedblue"
            style={{
          ...
          >
            <span>🛡️</span>
            <span className="font-body">Plataforma Educativa Verificada</span>
          </motion.div>
      ...
      >
        <ChevronDown className="w-6 h-6 text-mutedblue" />
      </motion.div>
    </section>
  );
}
