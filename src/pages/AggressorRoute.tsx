          ...
          <AnimatePresence mode="wait">
            ...
            {activeModule === 0 && (
              <motion.div key="sim" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 10 }}>
                {!isSimFinished ? (
                  ...
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="p-6 sm:p-12 text-center rounded-3xl border border-white/10 bg-white/30 backdrop-blur-md">
            ...
            {activeModule === 1 && (
              <motion.div key="test" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }}>
                {profileResult ? (
                  <div className="rounded-3xl border border-white/10 bg-white/30 backdrop-blur-md p-6 sm:p-10 text-center">
